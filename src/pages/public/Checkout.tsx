...
export default function Checkout() {
  ...
  const { data: enrollment } = useCourseEnrollment(
    courseId || "",
    ...
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center gap-4 bg-white px-4 text-center">
        ...
        <p className="max-w-md text-sm text-zinc-500">
          We could not load this checkout page.
        </p>
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(17,24,39,0.06),_transparent_36%),linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] px-4 py-8 text-zinc-900 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
        <div className="flex items-center justify-between">
          <Button
            variant="ghost"
            className="gap-2 px-0 text-zinc-600 hover:text-zinc-900"
            onClick={() => navigate(-1)}
          >
            ...
            <CardContent className="space-y-6 p-6 sm:p-8">
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm leading-6 text-zinc-600">
                  Complete your enrollment securely. Your payment will be
                  verified by the backend before access is unlocked.
                </p>
              </div>
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                  ...
                  <p className="mt-2 text-lg font-semibold text-zinc-900">
                    {formatMoney(
                      Number(course.selling_price ?? course.buying_price ?? 0),
                    )}
                  </p>
                </div>
                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Button
                  ...
                  disabled={
                    isLaunching || state === "processing" || Boolean(enrollment)
                  }
                >
                  {isLaunching || state === "processing" ? (
            ...
            <CardContent className="space-y-5 p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-zinc-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    variant="ghost"
                    className="h-8 gap-2 px-0 text-white hover:bg-white/10 hover:text-white"
                    onClick={startCheckout}
                  >
